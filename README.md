## opw_kinematics (noetic) - 0.5.0-1

The packages in the `opw_kinematics` repository were released into the `noetic` distro by running `/usr/bin/bloom-release opw_kinematics --rosdistro noetic` on `Tue, 05 Jul 2022 18:52:30 -0000`
...
## opw_kinematics (noetic) - 0.4.6-1

The packages in the `opw_kinematics` repository were released into the `noetic` distro by running `/usr/bin/bloom-release opw_kinematics --rosdistro noetic` on `Sun, 26 Jun 2022 17:54:53 -0000`
...
## opw_kinematics (melodic) - 0.4.5-1

The packages in the `opw_kinematics` repository were released into the `melodic` distro by running `/usr/bin/bloom-release opw_kinematics --rosdistro melodic --edit` on `Thu, 24 Mar 2022 14:50:05 -0000`
...
## opw_kinematics (noetic) - 0.4.5-1

The packages in the `opw_kinematics` repository were released into the `noetic` distro by running `/usr/bin/bloom-release opw_kinematics --rosdistro noetic --edit` on `Thu, 24 Mar 2022 14:48:40 -0000`
